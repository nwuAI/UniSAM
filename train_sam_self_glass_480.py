...
from DataLoader import TrainingDataset_Glass, stack_dict_batched
...
def main(args):
    ...
    train_dataset = TrainingDataset_Glass(args.data_path, image_size=args.image_size, mode='train', point_num=1, mask_num=args.mask_num, requires_name=False)
